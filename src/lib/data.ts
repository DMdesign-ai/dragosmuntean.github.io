...
export const projects: Project[] = [
  {
    id: 'trailsync',
    name: 'TrailSync',
    description: 'Fitness tracking dashboard with real-time analytics',
    points: 1500,
    techTag: 'REACT+NODE',
    icon: 'code',
  },
  {
    id: 'paceapi',
    name: 'PaceAPI',
    description: 'Running analytics API with performance metrics',
    points: 2200,
    techTag: 'REST API',
    icon: 'box',
  },
  {
    id: 'runneros',
    name: 'RunnerOS',
    description: 'CLI tool for runners with route planning engine',
    points: 1800,
    techTag: 'CLI TOOL',
    icon: 'terminal',
  },
